...
<template>
  <dl class="print-inline grid grid-cols-2 gap-px overflow-hidden rounded-lg bg-boter-400 sm:grid-cols-5">
    <div
      v-for="item in items"
      :key="item.label"
    ...
    >
      <dt class="flex items-center gap-1.5 text-xs uppercase tracking-wide text-boter-900 dark:text-boter-200">
        <UIcon
          :name="item.icon"
          class="size-3.5"
        />
