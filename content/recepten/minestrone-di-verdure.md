...
description: "De Italiaanse groentesoep zoals hij hoort: dik, seizoensgebonden en gebonden door de groenten zelf. Met een korst Parmigiano die meekookt voor extra diepte."
  ...
  - groep: Groenten
    items:
      ...
      - hoeveelheid: "200"
        ...
        naam: groene bonen
      - hoeveelheid: "2"
        naam: vastkokende aardappels
      - hoeveelheid: "200"
        eenheid: g
        naam: savooiekool
        opmerking: in reepjes
      - hoeveelheid: "400"
        eenheid: g
...
stappen:
  ...
  - titel: Harde groenten eerst
    tekst: Voeg de aardappel, groene bonen en savooiekool toe en bak vijf minuten mee. Roer de tomaten erdoor en laat twee minuten inkoken.
    tip: Groenten toevoegen op volgorde van kooktijd is het hele geheim van een goede minestrone. Alles tegelijk erin betekent dat de helft papperig is voor de rest gaar is.
  - titel: Sudderen met de kaaskorst
    tekst: Schenk de bouillon erbij, leg de korst Parmigiano in de pan en laat vijfentwintig minuten zachtjes koken.
    tip: Gooi kaaskorsten nooit weg. Ze lossen langzaam op en geven de soep een hartige diepte waar geen bouillonblokje aan tipt.
  - titel: Zachte groenten en pasta
    tekst: Voeg de courgette, de borlottibonen en de pasta toe en kook nog tien minuten tot de pasta gaar is.
  - titel: Rusten en serveren
    tekst: Haal de kaaskorst eruit, zet het vuur uit en laat de soep tien minuten staan. Serveer met een royale scheut olijfolie en versgeraspte Parmigiano.
voedingswaarde:
  calorieen: 340
  eiwitten: 13
  koolhydraten: 52
...
zoekwoorden:
  ...
  secundair:
    ...
    - minestrone met bonen
    - minestrone vegetarisch
    - dikke groentesoep italiaans
  zoekintentie: informationeel
---

Minestrone is geen recept maar een methode. In Italië maak je hem met wat het seizoen geeft, en daarom ziet hij er in november anders uit dan in juni. Wat altijd hetzelfde blijft: een soffritto als basis, groenten op volgorde van kooktijd, en genoeg tijd om alles in elkaar te laten overgaan.

## Dik, niet waterig

Een goede minestrone hoort dik genoeg te zijn om de lepel er bijna rechtop in te zetten. Dat komt niet van bloem of room, maar van de aardappel en de bonen die tijdens het koken uiteenvallen. Wil je hem nog dikker, pureer dan een soeplepel bonen en roer die er terug door.

## De kaaskorst

Bewaar de korsten van je Parmigiano in de vriezer. Ze zijn te hard om te eten maar zitten vol umami, en tijdens een half uur sudderen geven ze die volledig af aan de soep. Dit is de meest onderschatte truc in de Italiaanse keuken.
